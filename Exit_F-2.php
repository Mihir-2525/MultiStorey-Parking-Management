...
<head>
    ...
    <style>
        ...
        .active {
            color: black;
            animation-timing-function: cubic-bezier(1, 1.23, 1, 1.23);
            position: relative;
            animation: mymove 1s;
            size: 25px;
        }
...
if (isset($_POST['dlt'])) {
    ...
    $queryThree = "DELETE FROM parking WHERE floor = 2 AND slot_no = ?";
    ...
    <header>
        <nav>
            <ul>
                ...
                <li><a href="./Exit_F-1.php">Floor-1</a></li>
                <li><a href="./Exit_F-2.php" class="active">Floor-2</a></li>
            </ul>
        </nav>
    </header>
    <div class="parking" style="display: flex;flex-direction: column;align-items: center;">
        <div class="slot-display"><?php slot_check(); ?>
