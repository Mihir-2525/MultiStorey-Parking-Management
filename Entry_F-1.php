        ...
        if ($vhno !== "" && $mono !== "") {
            if (preg_match('/^[A-Z]{2}[0-9]{2}[A-Z]{2}[0-9]{4}$/', $vhno)) {
                if (preg_match('/^[0-9]{10}$/', $mono)) {
                    // Insert Data into DB
                    $sql = "INSERT INTO `parking` (`Operator`,`floor`,`slot_no`,`vh_no`,`mobile_no`,`mail`,`entrytime`) VALUES ('$operator','1','$slot_no', '$vhno','$mono','$mail', current_timestamp());";
    ...
    <header>
        <nav>
            <ul>
                ...
                <li><a href="./Entry_F-1.php" class="active">Floor-1</a></li>
